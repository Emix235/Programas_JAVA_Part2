...
public class Renta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, 480, 60));
        ...
        jPanel2.add(agreg, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 170, 160, 30));
        ...
        jPanel2.add(GENERAR, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 280, 170, 30));
        ...
        jPanel2.add(TOTAL, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 290, 150, -1));
        ...
        CANT.setEditor(new javax.swing.JSpinner.NumberEditor(CANT, ""));
        CANT.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                CANTStateChanged(evt);
            }
        });
        jPanel2.add(CANT, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, 50, -1));
        ...
        jPanel2.add(BORRAR, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 110, 20));
        ...
        jPanel2.add(pt, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 160, 90, -1));
        ...
        DESCRIP.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        ...
        jPanel2.add(DESCRIP, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 30, 200, 90));

        OPCIONES.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Agua", "Gas", "Renta" }));
        ...
        jPanel2.add(OPCIONES, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, 120, -1));

        jPanel3.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 520, 320));
        ...
        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 540, 370));
        ...
        jPanel1.add(Salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 20, -1, 90));
        ...
        jPanel1.add(ne, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 230, 90, 60));
...
//        m.setVisible(true);
    ...
    private void agregActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregActionPerformed
        ...
        int s = 0;
        int i=0,mi=1;
        if(OPCIONES.getSelectedItem().toString().equals("Agua")){
        s = ag* c;
        }
        if(OPCIONES.getSelectedItem().toString().equals("Gas")){
        s = g* c;
        }
        if(OPCIONES.getSelectedItem().toString().equals("Renta")){
        s = re* c;
        }
        a[0]=(String) OPCIONES.getSelectedItem();
...
//        r.mo1.addRow(a);
    ...
    private void CANTStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_CANTStateChanged
        c=(int) CANT.getValue();
        int a = 1;
        if(OPCIONES.getSelectedItem().equals("Agua")){
        a=121*c;
        }
        if(OPCIONES.getSelectedItem().equals("Gas")){
        a=400*c;
        }
        if(OPCIONES.getSelectedItem().equals("Renta")){
        a=450*c;
        }
...
//            r.mo1.removeRow(f1);
    ...
    private void OPCIONESActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OPCIONESActionPerformed
        int m = OPCIONES.getSelectedIndex();
        DESCRIP.setText("");
        if(m == 0){
        precio.setText(" $ 121");
