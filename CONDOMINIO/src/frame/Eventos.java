...
public class Eventos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        EVE.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Reunión", "Boda", "Cumpleaños", "Fiesta Religiosa", "Fiesta" }));
        EVE.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EVEActionPerformed(evt);
            }
        });
        jPanel1.add(EVE, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 30, 140, 30));
        ...
        NAMES.setHorizontalAlignment(javax.swing.JTextField.CENTER);
    ...
    private void GUARDAR2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GUARDAR2ActionPerformed
        ...
        if(LUGAR.getSelectedItem().toString().equals("Casa")){
            c=NAMES.getText()+" organizarán un(a) "+ (String)EVE.getSelectedItem()+
                " ,en su "+(String)LUGAR.getSelectedItem()+ " No."+M.getValue()+".\n"+
                    "El Dia: "+d+" de "+añ[m-1]+" del año: "+a+"\n";
        }else{
        c=NAMES.getText()+" organizarán una "+ (String)EVE.getSelectedItem()+
    ...
    private void EVEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EVEActionPerformed

        String mn= EVE.getSelectedItem().toString();
        if(mn.equals("Reunión")){
